      ...
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md">
        ...
        <form onSubmit={onLogin} className="space-y-4">
          <div>
            ...
            <input type="email" required defaultValue="marc@example.com" className="w-full p-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none text-slate-800" />
          </div>
          <div>
            <label className="block text-sm font-medium text-slate-600 mb-1">Password</label>
            <input type="password" required defaultValue="password123" className="w-full p-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none text-slate-800" />
          </div>
    ...
    <div className="space-y-6">
      ...
      {showModal && (
        <div className="fixed inset-0 bg-slate-900/50 flex items-end sm:items-center justify-center p-4 z-50">
          <div className="bg-white w-full max-w-md rounded-3xl sm:rounded-2xl p-6 shadow-2xl">
